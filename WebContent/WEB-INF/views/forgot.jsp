	...
	<div id="page-content" class="page-content page-content-gray">	
			<div id="page-content-scroll" class="header-clear-larger"><!--Enables this element to be scrolled --> 	
				...
				<div class="page-login content-boxed content-boxed-padding no-top">
					<img class="preload-image login-bg responsive-image no-bottom" src="${pageContext.request.contextPath}/contents/images/BG5.jpg" data-src="${pageContext.request.contextPath}/contents/images/BG5.jpg" alt="img">
					...
					<p class="smaller-text half-bottom">Recover your password, just enter your email.</p>
					<div class="page-login-field half-top full-bottom">
						<i class="fa fa-at"></i>
						<input type="text" placeholder="What's your Email?">
						<em>(required)</em>
					</div>			
					<a href="#" class="button button-blue button-full button-rounded button-s uppercase ultrabold">password reset</a>
				</div>	
			</div>
